...
from architecture2 import HB_transformer as net
import config as cfg

save_path = "/home/DATA/ymh/s_modeling/redata4/model_save"
##############################################################################################################################
input_path = "/home/DATA/ymh/s_modeling/redata4"
...
for test_idx in range(5):
    ...
    train_loader = DataLoader(dataset=dataset, batch_size=128, sampler=train_sampler)#, num_workers=32)
    valid_loader = DataLoader(dataset=dataset, batch_size=128, sampler=valid_sampler)#, num_workers=32)
    ...
    for epoch in range(80):
        ...
        if (epoch+1) % 1 == 0:
            ...
            if (epoch+1) > 10 and precision >= best_precision:
